                                    ...
                                    <table id="example1" class="table table-sm table-bordered table-hover">
                                        ...
                                        @foreach($allData as $key => $customer)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-dark" title="edit" href="{{route('customers-edit',$customer->id)}}"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-dark" id="delete" title="edit" href="{{route('customers-delete',$customer->id)}}"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
